...
const Footer = () => {
  ...
  const footerLinks = {
    quickLinks: [
      { name: t('quickLinks.requestSolution'), href: "#" },
      { name: t('quickLinks.aiFeatures'), href: "#features" },
      { name: t('quickLinks.benefits'), href: "#benefits" }
    ],
    legal: [
      { name: t('legal.privacyPolicy'), href: "/privacy" },
      { name: t('legal.termsOfService'), href: "/terms" },
      { name: t('legal.cookieSettings'), href: "/cookies" }
    ]
  };

  return (
    <footer className=''>
      <div className=" bg-[#18232D] py-8 md:px-4 rounded-3xl">
        ...
        <div className="grid grid-cols-1 items-center justify-center md:grid-cols-5 gap-12 md:gap-8 mb-12">
          ...
          <div className='text-center md:text-left md:col-span-3'>
            ...
            <div className="space-y-2 text-center md:text-left md:w-fit">
              <p className="text-slate-300 md:text-left text-base">{t('location')}</p>
              <p className="text-slate-300 md:text-left text-base mt-4">{t('email')}</p>
              <a 
          ...
          <div className=' w-fit mx-auto text-center md:text-left'>
            <h4 className="text-white/70 md:text-left font-normal mb-4 md:mb-6 text-lg">
              {t('quickLinks.title')}
            </h4>
